...
public class Zombie : LivingEntity
{
    ...
    private LivingEntity targetEntity; // 추적 대상 => 생명이 있는 오브젝트 따라다니기
    ...
    public float timeBetAttack = 0.5f; // 공격 간격 공격 체크
    ...
    private bool hasTarget //set이 없어서 읽기만 가능 기본구현(자동구현(?))
    {
        get
        {
    ...
    private void Awake()
    {
        ...
        zombieRenderer = GetComponentInChildren<Renderer>();//좀비 오브젝트의 하위 오브젝트의 렌더러를 가져오기
